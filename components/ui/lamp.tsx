  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-red-400 to-red-600 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
...
export const LampContainer = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute z-50 -translate-y-[-5rem] text-center">
        <h2 className="text-red-300 text-xl font-semibold tracking-wide animate-pulse">
          <TypewriterEffectFull/>
        </h2>
      </div>
    </div>
  );
